...
6. Then run the command "npm run dev" to start the app and follow the link given in the terminal
...
3. After choosing one of the two options for allowing there will be open a screen picker to choose the content anybody want to share
