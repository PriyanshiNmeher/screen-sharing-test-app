...
//   const handleStopFromFullscreen = () => { setIsFullscreen(false); stop() }

//   // When minimizing from fullscreen, reconnect the main <video> element to the stream
//   const handleMinimize = () => {
//     setIsFullscreen(false)
//     // Small delay so the main video element is back in DOM before reattaching
//     setTimeout(() => reattachVideo(), 30)
//   }

//   const is = (s) => status === s
//   const P = PermissionState

//   // Show permission badge label
//   const permBadgeLabel = permissionType === 'visiting'
...
//               {/* Permission type badge shown when active */}
//               {permBadgeLabel && (
//                 <span className={`perm-badge ${permissionType}`}>
//                   {permBadgeLabel}
//                 </span>
//               )}

//               {/* Revoke saved "while visiting" permission */}
//               {savedPermission?.type === 'visiting' && !is(P.GRANTED) && (
//                 <button className="revoke-link" onClick={revokePermission}>
//                   revoke
//                 </button>
//               )}
...
//                           <button className="vid-act-btn expand" onClick={() => setIsFullscreen(true)} title="Fullscreen">⛶</button>
//                         </div>
//                       </div>
...
//                   </div>
//                   <p className="error-desc">You dismissed the screen selector without choosing a source. No stream was created.</p>
...
//                     Screen capture was blocked — either you clicked "Don't Allow", or your OS/browser
//                     security settings are preventing screen recording.
//                   </p>
...
//                       <div>🔒 <strong>Chrome/Edge:</strong> Click the 🔒 lock icon in the address bar</div>
//                       <div style={{ paddingLeft: 22, color: 'var(--muted)' }}>→ Site settings → Screen capture → Allow</div>
//                       <div style={{ marginTop: 6 }}>🍎 <strong>macOS:</strong> System Preferences → Privacy & Security</div>
//                       <div style={{ paddingLeft: 22, color: 'var(--muted)' }}>→ Screen Recording → Enable your browser</div>
//                       <div style={{ marginTop: 6 }}>🪟 <strong>Windows:</strong> Settings → Privacy → Screen capture</div>
//                       <div style={{ paddingLeft: 22, color: 'var(--muted)' }}>→ Allow apps to capture your screen</div>
//                     </div>
//                   </div>
//                   <div className="btn-row">
//                     <Button onClick={start}>↻ &nbsp;Try Again</Button>
...
//                   </div>
//                   <p className="error-desc">An unexpected error occurred while initialising the media stream.</p>
...
//                   </div>
//                   <p>
//                     The screen share session has ended.<br />
//                     All media tracks have been released and the stream cleaned up.
//                     {permissionType === 'once' && (
//                       <><br /><span style={{ color: 'var(--muted)', fontSize: 12 }}>One-time permission has expired. You will be asked again next time.</span></>
//                     )}
//                     {savedPermission?.type === 'visiting' && (
//                       <><br /><span style={{ color: '#6699ff', fontSize: 12 }}>Session permission is still active — next share will skip the prompt.</span></>
//                     )}
//                   </p>
